...
def double_candle_breakout(symbol, type_filling, timeframe, sl_limit, sl_min, body_points_limit, points_gap_between_ideal_n_current_limit,
                         ...
                         enable_5_minute_drawdown_check, enable_spike_in_drawdown_check, enable_first_candle_close_healthcheck,
                         enable_60_minute_no_momentum_check, enable_90_minute_check, enable_add_position_when_price_reaches_half_tp):
    """
    USDJPY
    ...
    while True:
        ...
        # elif open_positions != 0:
            ...
            for position in positions:
                ...
                # Radical risk management. It can close the trade too early. Missed 2 could-be winning trades on Thu Jun 12 2025
                ...
                if enable_5_minute_drawdown_check:
                ...
                if enable_spike_in_drawdown_check:
                ...
                if enable_first_candle_close_healthcheck:
                ...
                if enable_60_minute_no_momentum_check:
                ...
                if enable_add_position_when_price_reaches_half_tp:
                ...
                # Added conditions below to limit adding position
                if enable_add_position_when_price_reaches_half_tp:
...
def main():
    ...
    enable_5_minute_drawdown_check = False
    enable_spike_in_drawdown_check = False
    enable_first_candle_close_healthcheck = False
    enable_60_minute_no_momentum_check = False
    enable_90_minute_check = False
    enable_add_position_when_price_reaches_half_tp = False
